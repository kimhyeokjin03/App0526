...
//     map.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
    ...
    GoogleMap.OnMarkerClickListener listener = new GoogleMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            if (marker.equals(seoul))
                Toast.makeText(MainActivity4.this, "여기는 서울입니다", Toast.LENGTH_SHORT).show();
            else
                Toast.makeText(MainActivity4.this, "여기는 인천입니다", Toast.LENGTH_SHORT).show();
            return false;
        }
    };
    ...
    GoogleMap.OnMapClickListener mapListener = new GoogleMap.OnMapClickListener() {
        ...
        public void onMapClick(LatLng point) {
            Toast.makeText(MainActivity4.this, point.latitude+":"+point.longitude, Toast.LENGTH_SHORT).show();
    ...
    GoogleMap.OnMyLocationChangeListener myListener = new GoogleMap.OnMyLocationChangeListener() {
        ...
        public void onMyLocationChange(Location location) {
            Toast.makeText(MainActivity4.this, location.getLatitude()+":"+location.getLongitude(), Toast.LENGTH_SHORT).show();
